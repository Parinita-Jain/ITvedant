...
select emp_no,emp_name from employee_j
where emp_add="chandigarh";

select * from emp_view;

alter view emp_view as 
select emp_no,concat(emp_name," : ",emp_add) as Info  from employee_j;
...
select emp_name,dept_name,employee_j.emp_no from employee_j inner join department_j
on employee_j.emp_no=department_j.emp_no;

select* from emp_view;

update emp_view set emp_name="amit" 
where emp_no=4;
